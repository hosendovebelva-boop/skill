...
```json
{"type": "text", "x": 100, "y": 100, "lines": ["问题 1", "未显式 BindNewSocket", "(client -> m_hIOCP)"],
 "style": {"fontSize": 16, "fill": "#111", "fontFamily": "system-ui, sans-serif"},
 "anchor": "middle", "baseline": "middle", "lineHeight": 1.28}
```

Anchors: `start | middle | end`
Baselines: `alphabetic | middle | hanging | central`
Use `lines` for deterministic multi-line layout, or embed `\n` in `text` when a literal string is more convenient.
...
### Hollow callout arrow

```json
{
  "defs": {
    "markers": [
      {"id": "calloutArrow", "markerWidth": 8, "markerHeight": 8, "refX": 7, "refY": 5,
       "viewBox": "0 0 8 10", "orient": "auto", "pathD": "M1 1 L7 5 L1 9",
       "style": {"fill": "none", "stroke": "#8b6b3f", "strokeWidth": 1.5, "strokeLinecap": "round", "strokeLinejoin": "round"}}
    ]
  }
}
```

Use this for dashed or crowded callout connectors where a filled arrowhead would overpower the layout.
